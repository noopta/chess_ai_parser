export default function ProgressBar({whiteChances}) {
    console.log("whiteChances", whiteChances);
    return (
      <div>
        ...
        <div aria-hidden="true" className="mt-6">
          <div className="overflow-hidden rounded-full bg-gray-200">
            {/* <div style={{ width: '47.5%' }} className="h-2 rounded-full bg-indigo-600" /> */}
            <div style={{ width: whiteChances }} className="h-2 rounded-full bg-indigo-600" />
          </div>
